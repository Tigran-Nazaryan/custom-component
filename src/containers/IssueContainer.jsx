...
const IssueContainer = () => {
  ...
  const handleDeleteConfirmed = () => {
    setIssues(deleteIssue(issues, issueToDelete.id));
  ...
  return (
    <div className="flex flex-col mx-auto max-w-[1280px] w-full h-screen gap-5">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-[rgba(255,255,255,0.5)] flex items-center justify-center z-1">
          <div className="bg-white p-6 rounded shadow-lg w-full max-w-md text-center">
            <h2 className="text-xl font-semibold mb-4">Delete issue?</h2>
